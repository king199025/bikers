...
use backend\modules\clubs\models\Clubs;

/**
 * ClubsSearch represents the model behind the search form about `backend\modules\clubs\models\Clubs`.
 */
class ClubsSearch extends Clubs
{
    ...
    {
        return [
            [['id', 'type', 'filial', 'dt_start', 'status', 'user_id'], 'integer'],
