            ...
            <div class="news__expected">
                ...
                <div class="news__expected_item">
                    ...
                    <div class="news__expected_item_desc">
                        <strong class="news__expected_item_title"><?=$item['events']->name;?></strong>
							<span class="news__expected_item_place">
								Opr:
								<a href="<?=\yii\helpers\Url::to(['/events/default/view','id'=>$item['events']->id])?>"><?=$item['events']->name; ?></a>
							</span>
                        <small class="news__expected_item_date"><?=date('d.M.Y',$item['events']->dt_start)?></small>
                    </div>
                    <!-- close .news__expected_item_desc -->
                    <a href="<?=\yii\helpers\Url::to(['/events/default/view','id'=>$item['events']->id]); ?>" class="news__expected_item_see">
