                ...
                <div class="news__expected">
                    ...
                    <div class="news__expected_item">
                        ...
                        <div class="news__expected_item_desc">
                            <strong class="news__expected_item_title">Byke party Taganrog 2016 День рождения клуба</strong>
                            <span class="news__expected_item_place">
								Opr:
								<a href="#">Fire Motors MC Taganrog</a>
							</span>
                            <small class="news__expected_item_date">13.04.2016</small>
                        </div>
                        <!-- close .news__expected_item_desc -->
                        <a href="#" class="news__expected_item_see">
            ...
            <div class="events__flex">
                ...
                <div class="events__box">
                    <a href="#" class="events__item">
                        <img src="img/placeholder.jpg" alt="" class="events__item_thumb" />
                        <span class="events__item_desc">Byke party Taganrog 2016 День рождения клуба</span>
                    </a>
                    <a href="#" class="events__item">
                        <img src="img/placeholder.jpg" alt="" class="events__item_thumb" />
                        <span class="events__item_desc">Byke party Taganrog 2016 День рождения клуба</span>
                    ...
                    <a href="#" class="events__item">
                        <img src="img/placeholder.jpg" alt="" class="events__item_thumb" />
                        <span class="events__item_desc">Byke party Taganrog 2016</span>
                    </a>
                    <a href="#" class="events__item">
                        <img src="img/placeholder.jpg" alt="" class="events__item_thumb" />
                        <span class="events__item_desc">Byke party Taganrog 2016 День рождения клуба</span>
                    ...
                    <a href="#" class="events__item">
                        <img src="img/placeholder.jpg" alt="" class="events__item_thumb" />
                        <span class="events__item_desc">Byke party Taganrog </span>
                    </a>
                    <a href="#" class="events__item">
                        <img src="img/placeholder.jpg" alt="" class="events__item_thumb" />
                        <span class="events__item_desc">Byke party Taganrog 2016 День рождения клуба</span>
                    ...
                    <a href="#" class="events__item">
                        <img src="img/placeholder.jpg" alt="" class="events__item_thumb" />
                        <span class="events__item_desc">День рождения клуба</span>
                    </a>
                    <a href="#" class="events__item">
                        <img src="img/placeholder.jpg" alt="" class="events__item_thumb" />
                        <span class="events__item_desc">Byke party Taganrog 2016 День рождения клуба</span>
                ...
                <div class="events__add">
                    ...
                    <a href="#" class="button button_orange">+ Добавить мероприятие</a>
                    <blockquote>
            ...
            <div class="motocalendar__tab motocalendar__content">
                ...
                <aside class="motocalendar__list">
                    ...
                    <div class="motocalendar__list_tab motocalendar__list_box">
                        ...
                        <a href="#nowhere" class="motocalendar__list_item">
                            <span class="motocalendar__list_title">Выставка “МОТОВЕЛОЭКСПО-2016”</span>
                            <small>Начало: <span class="motocalendar__list_start">14.04.2016</span></small>
                            <small>Окончание: <span class="motocalendar__list_end">16.04.2016</span></small>
                ...
                <article class="motocalendar__event">
                    ...
                    <div class="motocalendar__event_box">
                        ...
                        <div class="motocalendar__event_desc">
                            ...
                            <a href="#" class="button button_orange">УЗНАТЬ ПОДРОБНЕЕ</a>
                        </div>
